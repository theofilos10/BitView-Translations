<?php
/* General stuff */
$LANGS['language'] = 'Έλληνικα';
$LANGS['languageenglish'] = 'Ελληνικά';
$LANGS['languagecode'] = 'el_GR.UTF-8'; /* Leave the ".UTF-8" in the end as-is, as it might break some dates */
$LANGS['languagechange'] = 'Η γλώσσα ρυθμύστηκε σε ελληνικά.';
...
/* Language window */
$LANGS['welcometobitview'] = 'Καλώς Ήρθατε στο BitView!';
$LANGS['languagesuggestion'] = 'Προτεινόμενη γλώσσα (έχουμε ορίσει την προτίμησή σας σε αυτό):';
$LANGS['languagesuggestiondesc1'] = 'Για να αλλάξετε τη γλώσσα που προτιμάτε, χρησιμοποιήστε τον επιλογέα γλώσσας στο υποσέλιδο (τέλος της σελίδας).';
$LANGS['languagesuggestiondesc2'] = 'Κάντε κλικ στο "OK" για να αποδεχτείτε αυτήν τη ρύθμιση ή κάντε κλικ στο "Ακύρωση" για να δείτε τον ιστότοπο στα Αγγλικά.';

/* Time, dates, etc */
$LANGS['second'] = 'δευτερόλεπτο';
$LANGS['minute'] = 'λεπτό';
$LANGS['hour'] = 'ώρα';
$LANGS['day'] = 'ημέρα';
$LANGS['week'] = 'εβδομάδα';
$LANGS['month'] = 'μήνα';
$LANGS['year'] = 'χρόνο';
$LANGS['seconds'] = 'δευτερόλεπτα';
$LANGS['minutes'] = 'λεπτά';
$LANGS['hours'] = 'ώρες';
$LANGS['days'] = 'ημέρες';
$LANGS['weeks'] = 'εβδομάδες';
$LANGS['months'] = 'μήνες';
$LANGS['years'] = 'χρόνια';
$LANGS['ago'] = 'πριν από {t}';
$LANGS['january'] = 'Ιανουάριος';
$LANGS['february'] = 'Φεβρουάριος';
$LANGS['march'] = 'Μάρτιος';
$LANGS['april'] = 'Απρίλιος';
$LANGS['may'] = 'Μάιος';
$LANGS['june'] = 'Ιούνιος';
$LANGS['july'] = 'Ιούλιος';
$LANGS['august'] = 'Αύγουστος';
$LANGS['september'] = 'Σεπτέμβριος';
$LANGS['october'] = 'Οκτώμβριος';
$LANGS['november'] = 'Νοέμβριος';
$LANGS['december'] = 'Δεκέμβριος';
...
$LANGS['timenumberformat'] = 'λ.η.Χ';

/* Header */
$LANGS['home'] = 'Αρχική';
$LANGS['videos'] = 'Βίντεο';
$LANGS['channels'] = 'Κανάλια';
$LANGS['community'] = 'Κοινότητα';
$LANGS['search'] = 'Αναζήτηση';
$LANGS['login'] = 'Είσοδος';
$LANGS['or'] = 'ή';
$LANGS['signup'] = 'Δημιουργία Λογαριασμού';
$LANGS['logout'] = 'Αποσύνδεση';
$LANGS['upload'] = 'Ανέβασμα';
$LANGS['subscriptions'] = 'Εγγραφές';
$LANGS['history'] = 'Ιστορικό';
$LANGS['account'] = 'Λογαριασμός';
$LANGS['myvideos'] = 'Τα Βίντεο Μου';
$LANGS['favorites'] = 'Αγαπημένα';
$LANGS['playlists'] = 'Λίστες αναπαραγωγής';
$LANGS['help'] = 'Βοήθεια';
$LANGS['suggestions'] = 'Προτάσεις';
$LANGS['quicklist'] = 'QuickList';
$LANGS['browse'] = 'Περιήγηση';
$LANGS['messagesmenu'] = 'Μηνύματα';
$LANGS['myvideos&playlists'] = 'Τα Βίντεο & οι Λίστες Αναπαραγωγής μου';

/* Homepage */
$LANGS['viewall'] = 'εμφάνιση όλων';
$LANGS['videoviews'] = 'προβολές';
$LANGS['beingwatched'] = 'Βίντεο Που Βλέπονται Τώρα';
$LANGS['featured'] = 'Επιλεγμένα Βίντεο';
$LANGS['recommendedforyou'] = 'Προτεινόμενα Για Εσάς';
$LANGS['mostpopular'] = 'Πιο Δημοφιλής;
$LANGS['inboxstats'] = 'Εισερχόμενα & Στατιστικά';
$LANGS['profilesettings'] = 'ρυθμίσεις λογαριασμού';
$LANGS['messages'] = 'Μηνύματα';
$LANGS['message'] = 'Μήνυμα';
$LANGS['comments'] = 'Σχόλια';
$LANGS['comment'] = 'Σχόλιο';
$LANGS['sharedwithyou'] = 'Σε κοινή χρήση με Εσάς';
$LANGS['sharedwithyousingular'] = 'Σε κοινή χρήση με Εσάς';
$LANGS['videoresponses'] = 'Απαντήσεις Βίντεο';
$LANGS['videoresponse'] = 'Απάντηση Βίντεο';
$LANGS['friendinvites'] = 'Προσκλήσεις Φίλων';
$LANGS['friendinvite'] = 'Προσκλήση Φίλου';
$LANGS['subscribers'] = 'Συνδρομητές';
$LANGS['subscriber'] = 'Συνδρομητής';
$LANGS['totalviews'] = 'Συνολικές Προβολές';
$LANGS['sendmessage'] = 'αποστολή μηνύματος';
$LANGS['whatsnew'] = "Τι Είναι Καινούργιο";
$LANGS['readmore'] = 'Διάβασε περισσότερα στο blog';
$LANGS['videocontest'] = 'Διαγωνισμός Βίντεο';
$LANGS['joincontest'] = 'Συμμετάσχετε στον διαγωνισμό τώρα!';
$LANGS['personalize'] = 'Θέλετε να προσαρμόσετε αυτήν την αρχική σελίδα;';
$LANGS['signinnow'] = '<a href="/login">Είσοδος</a> or <a href="/signup">Εγγραφή</a> τώρα!';
$LANGS['nowconverting'] = "Αυτό το βίντεο μετατρέπεται, περιμένετε λίγα λεπτά.";
$LANGS['modules'] = "Προσθήκη / Αφαίρεση μονάδων";
$LANGS['friendactivity'] = "Δραστηριότητα Φίλων";
$LANGS['customizehomepage'] = "Προσαρμογή Αρχικής Σελίδας";
$LANGS['customizethehomepage'] = "Προσαρμόστε την Αρχική Σελίδα";
$LANGS['customizehomepagedesc'] = "Επιλέξτε τις ενότητες που θέλετε να δείτε στην προσαρμοσμένη αρχική σας σελίδα.";
$LANGS['displaypreferences'] = "Προτιμήσεις Eμφάνισης";
$LANGS['thefeed'] = "Η Ροή";
$LANGS['thefeeddesc'] = "Συνδυάστε όλες τις ενότητες σας σε μια ενιαία ροή.";
$LANGS['friendactivitytitle'] = "Δραστηριότητα Φίλων - Μπορεί να δει ο κόσμος τι κάνω;";
$LANGS['friendactivitydesc'] = "Αυτή η ενότητα δείχνει στους επιβεβαιωμένους φίλους σας τις ενέργειες που δημοσιεύετε στο πρόσφατο ιστορικό δραστηριότητάς σας. Για παράδειγμα, αν έχετε ένα βίντεο ως αγαπημένο, τότε το νέο αγαπημένο σας βίντεο μπορεί να εμφανιστεί στο πλαίσιο Πρόσφατη Δραστηριότητα του καναλιού σας, καθώς και στην αρχική σελίδα των φίλων σας.";
$LANGS['feedfeatured'] = "Επιλεγμένο Βίντεο";
$LANGS['feedbeingwatched'] = "Βίντεο που βλέπεται τώρα";
$LANGS['feedrecommended'] = "Προτεινόμενο Βίντεο";
$LANGS['homenosubscriptions'] = "Δεν έχετε εγγραφεί σε κανένα κανάλι ακόμα";
$LANGS['homenosubscriptionsdesc'] = "Όταν προσθέτετε νέες συνδρομές, θα εμφανίζουμε τις μεταφορτώσεις τους εδώ σε αυτήν τη σελίδα.";
$LANGS['homenofriendactivity'] = "Οι φίλοι σας δεν είναι ενεργοί τον τελευταίο καιρό.";
$LANGS['homenofriendactivitydesc'] = "Μπορείτε να δοκιμάσετε να προσθέσετε μερικούς φίλους. Έτσι, θα δείξουμε την δραστηριότητα τους εδώ σε αυτήν τη σελίδα";
$LANGS['homeediting'] = "Επεξεργασία";
$LANGS['homedisplay'] = "Προβολή ως";
$LANGS['homerows'] = "Αριθμός σειρών για εμφάνιση";
$LANGS['gridview'] = "Προβολή Πλέγματος";
$LANGS['listview'] = "Προβολή Λίστας";
$LANGS['recommendedtitle'] = "Εξατομικευμένες προτάσεις βίντεο";
$LANGS['recommendeddesc'] = "Η λήψη εξατομικευμένων προτάσεων είναι πολύ εύκολη, το μόνο που έχετε να κάνετε είναι να παρακολουθήσετε μερικά βίντεο και μετά να επιστρέψετε σε αυτήν τη σελίδα για να δείτε ποια βίντεο έχει προτείνει το BitView μόνο για εσάς!";
$LANGS['jointitle'] = "Συμμετάσχετε στην μεγαλύτερη παγκόσμια κοινότητα κοινής χρήσης βίντεο!";
$LANGS['joindesc'] = "Έχετε ήδη λογαριασμό;";
$LANGS['newhomepagetitle'] = "Θέλετε να δοκιμάσετε μια διαφορετική αρχική σελίδα BitView;";
$LANGS['newhomepagedesc'] = "(Μην ανησυχείτε, μπορείτε να επιστρέψετε)";
$LANGS['newhomepagebutton'] = "Δοκιμή διαφορετικής αρχικής σελίδας ›";
$LANGS['allactivity'] = "Όλη η δραστηριότητα";
$LANGS['subscriptionuploads'] = "Μεταφορτώσεις συνδρομών";
$LANGS['newhomepagewelcome'] = "Χρησιμοποιείτε μια πειραματική αρχική σελίδα BitView.";
$LANGS['newhomepageback'] = "Πίσω στην κλασσική αρχική σελίδα";
$LANGS['loadmorevideos'] = "Φόρτωση περισσότερων βίντεο";
$LANGS['uploadedby'] = "Ανέβηκε από {u}";
$LANGS['favoritedby'] = "Αγαπημένο από {u}";
$LANGS['likedby'] = "Άρεσε από {u}";
$LANGS['previouslyviewed'] = "Είδατε προηγουμένως";

/* Page title */
$LANGS['hometitle'] = "Το BitView του/της {n}";
$LANGS['channeltitle'] = "Το κανάλι του/της {n}";
$LANGS['signintitle'] = "Είσοδος";
$LANGS['historytitle'] = "Ιστορικό Προβολής";
$LANGS['favtitle'] = "Αγαπημένα";
$LANGS['pltitle'] = "Λίστες Αναπαραγωγής";
$LANGS['partnerprogram'] = "Πρόγραμμα Συνεργάτη";

/* Notifications */
$LANGS['404error'] = "Συγγνώμη, η σελίδα που ζητήσατε δεν μπορεί να βρεθεί.";
$LANGS['searcherror'] = 'Το αναζήτηση σας θα πρέπει να είναι τουλάχιστον 2 χαρακτήρες!';
$LANGS['addvideoplaylist1'] = "Προσθέσατε";
$LANGS['addvideoplaylist2'] = 'βίντεο στη λίστα αναπαραγωγής σας!';
$LANGS['addfavorite1'] = "Κάνατε Αγαπημένο";
$LANGS['addfavorite2'] = 'βίντεο!';
$LANGS['groupdoesnotexist'] = "Αυτό το γκρούπ δεν υπάρχει!";
$LANGS['uploaddisabled'] = 'Η μεταφόρτωση έχει απενεργοποιηθεί για λόγους συντήρησης.';
$LANGS['vidsday'] = 'Δεν μπορείτε να ανεβάσετε περισσότερα από 3 βίντεο ανά 24 ώρες!';
$LANGS['3mins'] = 'Περιμένετε 3 λεπτά μέχρι να ανεβάσετε νέο βίντεο';
$LANGS['backgroundsuccess'] = 'Το banner ανέβηκε με επιτυχία!';
$LANGS['backgrounderror'] = 'Η εικόνα φόντου πρέπει να είναι κάτω από 2MB και να είναι αρχείο εικόνας!';
$LANGS['backgrounddeleted'] = 'Το banner διαγράφηκε με επιτυχία!';
$LANGS['bannersuccess'] = 'Το banner ανέβηκε με επιτυχία!';
$LANGS['bannererror'] = 'Η εικόνα banner πρέπει να είναι κάτω από 2MB και να είναι αρχείο εικόνας!';
$LANGS['bannerdeleted'] = 'Το banner σας διαγράφηκε με επιτυχία!';
$LANGS['minibannersuccess'] = 'Το μίνι banner ανέβηκε με επιτυχία!';
$LANGS['minibannererror'] = 'Η εικόνα του μίνι banner πρέπει να είναι κάτω από 2MB και να είναι αρχείο εικόνας!';
$LANGS['minibannerdeleted'] = 'Το μίνι banner σας διαγράφηκε με επιτυχία!';
$LANGS['sideimagesuccess'] = 'Η πλαϊνή εικόνα ανέβηκε με επιτυχία!';
$LANGS['sideimageerror'] = 'Η πλαϊνή εικόνα πρέπει να είναι κάτω από 2MB και να είναι αρχείο εικόνας!';
...
/* Watch */
$LANGS['moreinfo'] = 'περισσότερα';
$LANGS['lessinfo'] = 'λιγότερα';
$LANGS['category'] = 'Κατηγορία';
$LANGS['recordedon'] = 'Τραβηγμένο σε';
$LANGS['location'] = 'Τοποθεσία';
$LANGS['tags'] = 'Ετικέτες';
$LANGS['embed'] = 'Embed';
$LANGS['partnervideo'] = 'Βίντεο Συνεργασίας';
$LANGS['subscribe'] = 'Εγγραφή';
$LANGS['unsubscribe'] = 'Κατάργηση Eγγραφής';
$LANGS['nodesc'] = 'Δεν Υπάρχει Περιγραφή...';
$LANGS['logintosub'] = 'Συνδεθείτε για να εγγραφείτε!';
$LANGS['logintosubbox'] = 'Θέλετε να εγγραφείτε;';
$LANGS['subyourself'] = 'Δεν μπορείτε να εγγραφείτε στον εαυτό σας!';
$LANGS['videoowner'] = 'Επιλογές Κατόχου Βίντεο';
$LANGS['editvideo'] = 'Επεξεργασία Βίντεο';
$LANGS['insight'] = 'Insight';
$LANGS['morefrom'] = 'Περισσότερα Από:';
$LANGS['relatedvideos'] = 'Σχετικά Βίντεο';
$LANGS['novideosfound'] = 'Δεν βρέθηκαν βίντεο...';
$LANGS['morevideos'] = 'Εμφάνιση όλων των βίντεο';
$LANGS['changeplayersize'] = 'Αλλαγή Μεγέθους Player';
$LANGS['newwindow'] = 'Παρακολουθήστε αυτό το βίντεο σε νέο παράθυρο';
$LANGS['featuredtext'] = 'Αυτό το βίντεο έχει προβληθεί. Θέλετε να δείτε περισσότερα Επιλεγμένα βίντεο; <a href="/browse?t=2">Κάντε κλικ εδώ</a>.';
$LANGS['ratings'] = 'βαθμολογίες';
$LANGS['rating'] = 'βαθμολογία';
$LANGS['favorite'] = 'Αγαπημένο';
$LANGS['addtofav'] = 'Προσθήκη στα Αγαπημένα';
$LANGS['removefav'] = 'Αφαίρεση από Αγαπημένα';
$LANGS['favadded'] = 'Αυτό το βίντεο <strong>προστέθηκε</strong> στα <a href="/my_favorites">Αγαπημένα</a>.';
$LANGS['favremoved'] = 'Αυτό το βίντεο <strong>αφαιρέθηκε</strong> από τα <a href="/my_favorites">Αγαπημένα</a>.';
$LANGS['undo'] = 'Undo';
$LANGS['thanksforrating'] = 'Ευχαριστώ που βαθμολογήσατε!';
$LANGS['playlistdesc'] = 'Για να βάλετε ένα νέο βίντεο στην playlist σας, πάντε στη <a href="/my_playlists">"Οι Playlists μου"</a> σελίδα.';
$LANGS['addtoplaylist'] = 'Προσθήκη σε Playlist';
$LANGS['addtoplaylistsuccess'] = 'Το βίντεο προστέθηκε στην playlist σας.';
$LANGS['share'] = 'Κοινοποίηση';
$LANGS['flag'] = 'Αναφορά';
$LANGS['flagthisvid'] = 'Αναφορά Αυτού Του Βίντεο';
$LANGS['removeflag'] = 'Αφαίρεση Αναφοράς';
$LANGS['flagnote'] = "Πριν την αναφορά: βεβαιωθείτε ότι το βίντεο παραβιάζει οποιονδήποτε κανόνα. Μην κάνετε αναφορά μόνο και μόνο επειδή δεν σας αρέσει αυτό το βίντεο, αλλιώς θα εμποδίσετε τη δουλειά των moderators.";
$LANGS['statadded'] = 'Προστέθηκε';
$LANGS['statviews'] = 'Προβολές';
$LANGS['statratings'] = 'Βαθμολογίες';
$LANGS['statresponses'] = 'Απαντήσεις';
$LANGS['statcomments'] = 'Σχόλια';
$LANGS['statfavorited'] = 'Έγινε Αγαπημένο';
$LANGS['statsdata'] = 'Στατιστικά και Δεδομένα';
$LANGS['honors'] = 'Τιμές για αυτό το βίντεο';
$LANGS['mostviewed'] = 'Με τις περισσότερες προβολές';
$LANGS['topfavorited'] = 'Κορυφαία αγαπημένα';
$LANGS['times'] = 'φορές';
$LANGS['mostdiscussed'] = 'Πιο Συζητημένα';
$LANGS['toprated'] = 'Κορυφαία Βαθμολογία';
$LANGS['videolinks'] = 'Ιστότοποι που συνδέονται με αυτό το βίντεο';
$LANGS['clicksfrom'] = 'Κλικς από';
$LANGS['responses'] = 'Απαντήσεις Βίντεο';
$LANGS['responsespost'] = 'Δημοσίευση Απάντησης Βίντεο';
$LANGS['textcomments'] = 'Γραπτά Σχόλια';
$LANGS['commentpost'] = 'Δημοσίευση Γραπτού Σχόλιου';
$LANGS['commentonthisvideo'] = 'Σχολιάστε σε αυτό το βίντεο';
$LANGS['postcomment'] = 'Δημοσίευση Σχόλιου';
...
$LANGS['flaghatred2'] = "Δώστε επίσης τυχόν πρόσθετες πληροφορίες που πιστεύετε ότι θα μπορούσαν να μας βοηθήσουν να επαληθεύσουμε το πρόβλημα το συντομότερο δυνατό.";
$LANGS['flaggroup1'] = "ηλικία";
$LANGS['flaggroup2'] = "χρώμα";
$LANGS['flaggroup3'] = "αναπηρία";
$LANGS['flaggroup4'] = "εθνοτική καταγωγή";
$LANGS['flaggroup5'] = "ταυτότητα φύλου";
$LANGS['flaggroup6'] = "εθνική καταγωγή";
$LANGS['flaggroup7'] = "φυλή";
$LANGS['flaggroup8'] = "θρησκεία";
$LANGS['flaggroup9'] = "φύλο";
$LANGS['flaggroup10'] = "σεξουαλική συμπεριφορά";
$LANGS['flaggroup11'] = "κατάσταση βετεράνου";
$LANGS['thankyouflag'] = "Σας ευχαριστούμε που μοιραστήκατε τις ανησυχίες σας.";

/* Watch comments */
$LANGS['allcomments'] = 'Όλα τα Σχόλια';

/* Player */
$LANGS['fullscreen'] = "Πλήρης οθόνη";
$LANGS['expand'] = "Επέκταση";
$LANGS['shrink'] = "Σμίκρυνση";
$LANGS['popout'] = "Pop out";
$LANGS['mute'] = "Σίγαση";
$LANGS['unmute'] = "Κατάργηση σίγασης";

/* Sign In */
$LANGS['username'] = "Όνομα Χρήστη";
$LANGS['password'] = "Κωδικός";
$LANGS['logindesc'] = "Συνδεθείτε στο BitView με τον λογαριασμό σας";
$LANGS['forgot'] = "Δεν έχετε πρόσβαση στον λογαριασμό σας;";
$LANGS['forgotmsg'] = 'Επικοινωνήστε με τους συντονιστές στο Matrix χρησιμοποιώντας τον σύνδεσμο Chat στο υποσέλιδο.';
$LANGS['noaccount'] = "Δεν έχετε λογαριασμό;";
$LANGS['signuptobv'] = "Εγγραφείτε στο BitView!";
$LANGS['signintobv'] = "Συνδεθείτε στο BitView!";
$LANGS['signindesc1'] = "Γίνετε μέλος της μεγαλύτερης παγκόσμιας κοινότητας κοινής χρήσης βίντεο!";
$LANGS['signindesc2'] = "Το BitView είναι ένας τρόπος για να μεταφέρετε τα βίντεό σας στα άτομα που έχουν σημασία για εσάς. Με το BitView μπορείτε:";
$LANGS['signindesc3'] = "Να δείχνετε τα αγαπημένα σας βίντεο στον κόσμο";
$LANGS['signindesc4'] = "Να κάνετε blog τα βίντεο που τραβάτε με την ψηφιακή φωτογραφική μηχανή ή το κινητό σας τηλέφωνο";
$LANGS['signindesc5'] = "Να προβάλετε βίντεο με ασφάλεια και ιδιωτικότητα στους φίλους και την οικογένειά σας σε όλο τον κόσμο";
$LANGS['notallowed'] = "Έχετε αποκλειστεί ήδη 3 φορές. Δεν επιτρέπεται πλέον να χρησιμοποιείτε το BitView!";
$LANGS['wrongpassword'] = 'Λάθος κωδικός! Παρακαλούμε ξαναπροσπαθήστε.';
$LANGS['staysigned'] = "Να παραμείνω συνδεδεμένος/η";

/* Sign Up */
$LANGS['email'] = "Διεύθυνση email";
$LANGS['passwordstrength'] = "Ισχύς κωδικού πρόσβασης";
$LANGS['psnone'] = "Τίποτα";
$LANGS['psweak'] = "Αδύναμος";
$LANGS['psfair'] = "Δίκαιος";
$LANGS['psgood'] = "Καλός";
$LANGS['psstrong'] = "Δυνατός";
$LANGS['repassword'] = "Γράψτε ξανά τον κωδικό πρόσβασης";
$LANGS['usernamedesc'] = "Το όνομα χρήστη σας μπορεί να περιέχει μόνο γράμματα Α έως Z (λατινικά μόνο) ή αριθμούς 0-9.";
$LANGS['captcha'] = "Captcha";
$LANGS['acceptterms'] = 'Συμφωνώ με τους <a href="/terms">Όρους Χρήσης</a> και με την <a href="/privacy">Πολιτική Απορρήτου</a>.';
$LANGS['copyrighttext'] = 'Η μεταφόρτωση υλικού που δεν σας ανήκει αποτελεί παραβίαση πνευματικών δικαιωμάτων και είναι κατά του νόμου. Εάν ανεβάσετε υλικό που δεν σας ανήκει, ο λογαριασμός σας θα διαγραφεί.';
$LANGS['mustaccept'] = 'Πρέπει να αποδεχτείτε τους Όρους Χρήσης και την Πολιτική Απορρήτου για να δημιουργήσετε τον λογαριασμό σας';
$LANGS['createaccount'] = 'Δημιουργία λογαριασμού μου';
$LANGS['signuperror'] = 'Παρουσιάστηκε σφάλμα κατά τη δημιουργία του λογαριασμού σας.';
$LANGS['sameemail'] = 'Αυτό το όνομα χρήστη ή το email χρησιμοποιείται ήδη!';
$LANGS['usernamechar'] = 'Τα ονόματα χρήστη μπορούν να περιέχουν μόνο γράμματα (λατινικά μόνο) και αριθμούς!';
$LANGS['required'] = 'Όλα τα πεδία κειμένου είναι υποχρεωτικά!';
$LANGS['notmatch'] = "Οι κωδικοί δεν ταιριάζουν!";
$LANGS['signuphead'] = 'Ξεκινήστε με τον λογαριασμό σας';

/* Videos Page */
$LANGS['recentvideos'] = 'Πρόσφατα βίντεο';
$LANGS['random'] = 'Τυχαία';
$LANGS['dropdownmore'] = 'περισσότερα';
$LANGS['allcatin'] = 'μέσα';
$LANGS['allcat'] = 'Όλες οι Κατηγορίες';
$LANGS['categories'] = 'Κατηγορίες';
$LANGS['nomorevideos'] = 'Δεν βρέθηκαν άλλα βίντεο...';
$LANGS['timetoday'] = 'Σήμερα';
$LANGS['timeweek'] = 'Αυτήν την Εβδομάδα';
$LANGS['timemonth'] = 'Αυτόν τον Μήνα';
$LANGS['alltime'] = 'Όλων Των Εποχών';
$LANGS['when'] = 'Πότε';
$LANGS['videofavorites'] = 'αγαπημένα';
$LANGS['videocomments'] = 'σχόλια';
$LANGS['trendingtopics'] = 'Δημοφιλή Θέματα';
$LANGS['mostviewedtoday'] = 'Με Τις Περισσότερες Προβολές Σήμερα';
$LANGS['updated2hrs'] = 'Ενημερώνεται κάθε 2 ώρες';
$LANGS['bitviewcharts'] = 'BitView Charts';
$LANGS['mostdiscussedvideos'] = 'Πιο Συζητημένα Βίντεο';
$LANGS['mostliked'] = 'Τα Πιο Αγαπημένα';
$LANGS['mostviewedhd'] = 'Βίντεο HD Με Τις Περισσότερες Προβολές';
...
/* Channels Page */
$LANGS['mostsubscribed'] = 'Περισσότεροι Εγγεγραμμένοι';
$LANGS['lastlogin'] = 'Τελευταία Είσοδος';
$LANGS['cstatviews'] = 'Προβολές';
$LANGS['cstatvideos'] = 'Βίντεο';
$LANGS['cstatsubs'] = 'Συνδρομητές';
$LANGS['nochannels'] = 'Δεν βρέθηκαν άλλα κανάλια...';

/* Video Categories */
$LANGS['cat1'] = "Ταινίες & Animation";
$LANGS['cat2'] = "Αυτοκίνητα & Οχήματα";
$LANGS['cat3'] = "Εκπαίδευση & Διδασκαλία";
$LANGS['cat4'] = "Ψυχαγωγία";
$LANGS['cat5'] = "Γεγονότα & Γάμοι";
$LANGS['cat6'] = "Οικογένεια";
$LANGS['cat7'] = "Προς Πώληση & Δημοπρασίες";
$LANGS['cat8'] = "Χόμπι & Ενδιαφέροντα";
$LANGS['cat9'] = "Χιούμορ";
$LANGS['cat10'] = "Μουσική";
$LANGS['cat11'] = "Ειδήσεις & Πολιτικά";
$LANGS['cat12'] = "Περίεργα & Εξωφρενικά";
$LANGS['cat13'] = "Κόσμος & Blogs";
$LANGS['cat14'] = "Προσωπικά & Ραντεβού";
$LANGS['cat15'] = "Κατοικίδια & Ζώα";
$LANGS['cat16'] = "Επιστήμη & Τεχνολογία";
$LANGS['cat17'] = "Μικρές Ταινίες";
$LANGS['cat18'] = "Αθλητικά";
$LANGS['cat19'] = "Ταξίδια & Γεγονότα";
$LANGS['cat20'] = "Gaming";
$LANGS['cat21'] = "Βίντεο blogging";
...
$LANGS['type1p'] = "Μέλη";
$LANGS['type2'] = "Κωμικός";
$LANGS['type2p'] = "Κωμικοί";
$LANGS['type3'] = "Σκηνοθέτης";
$LANGS['type3p'] = "Σκηνοθέτες";
$LANGS['type4'] = "Γκουρού";
$LANGS['type4p'] = "Γκουρού";
$LANGS['type5'] = "Μουσικός";
$LANGS['type5p'] = "Μουσικοί";
$LANGS['type6'] = "Δημοσιογράφος";
$LANGS['type6p'] = "Δημοσιογράφοι";

/* Countries */
$LANGS['cat_AF'] = "Αφγανιστάν";
$LANGS['cat_AX'] = "Νήσοι Ώλαντ";
$LANGS['cat_AL'] = "Αλβανία";
$LANGS['cat_DZ'] = "Αλγερία";
$LANGS['cat_AS'] = "Αμερικανική Σαμόα";
$LANGS['cat_AD'] = "Ανδόρρα";
$LANGS['cat_AO'] = "Αγκόλα";
$LANGS['cat_AI'] = "Ανγκουίλα";
$LANGS['cat_AQ'] = "Ανταρκτική";
$LANGS['cat_AG'] = "Αντίγκουα και Μπαρμπούντα";
$LANGS['cat_AR'] = "Αργεντινή";
$LANGS['cat_AM'] = "Αρμενία";
$LANGS['cat_AW'] = "Αρούμπα";
$LANGS['cat_AU'] = "Αυστραλία";
$LANGS['cat_AT'] = "Αυστρία";
$LANGS['cat_AZ'] = "Αζερμπαϊτζάν";
$LANGS['cat_BS'] = "Μπαχάμες";
$LANGS['cat_BH'] = "Μπαχρέιν";
$LANGS['cat_BD'] = "Μπαγκλαντές";
$LANGS['cat_BB'] = "Μπαρμπάντος";
$LANGS['cat_BY'] = "Λευκορωσία";
$LANGS['cat_BE'] = "Βέλγιο";
$LANGS['cat_BZ'] = "Μπελίζ";
$LANGS['cat_BJ'] = "Μπενίν";
$LANGS['cat_BM'] = "Βερμούδα";
$LANGS['cat_BT'] = "Μπουτάν";
$LANGS['cat_BO'] = "Βολιβία";
$LANGS['cat_BQ'] = "Ολλανδία της Καραϊβικής";
$LANGS['cat_BA'] = "Βοσνία και Ερζεγοβίνη";
$LANGS['cat_BW'] = "Μποτσουάνα";
$LANGS['cat_BV'] = "Νησί Μπουβέ";
$LANGS['cat_BR'] = "Βραζιλία";
$LANGS['cat_IO'] = "Βρετανικό Έδαφος Ινδικού Ωκεανού";
$LANGS['cat_BN'] = "Μπρουνέι Νταρουσαλάμ";
$LANGS['cat_BG'] = "Βουλγαρία";
$LANGS['cat_BF'] = "Μπουρκίνα Φάσο";
$LANGS['cat_BI'] = "Μπουρούντι";
$LANGS['cat_KH'] = "Καμπότζη";
$LANGS['cat_CM'] = "Καμερούν";
$LANGS['cat_CA'] = "Καναδάς";
$LANGS['cat_CV'] = "Πράσινο Ακρωτήριο";
$LANGS['cat_KY'] = "Νησιά Κέιμαν";
$LANGS['cat_CF'] = "Κεντροαφρικανική Δημοκρατία";
$LANGS['cat_TD'] = "Τσαντ";
$LANGS['cat_CL'] = "Χιλή";
$LANGS['cat_CN'] = "Κίνα";
$LANGS['cat_CX'] = "Νησί των Χριστουγέννων";
$LANGS['cat_CC'] = "Νήσοι Κόκος (Κίλινγκ)";
$LANGS['cat_CO'] = "Κολομβία";
$LANGS['cat_KM'] = "Κομόρες";
$LANGS['cat_CG'] = "Δημοκρατία του Κονγκό";
$LANGS['cat_CD'] = "Λαϊκή Δημοκρατία του Κονγκό";
$LANGS['cat_CK'] = "Νήσοι Κουκ";
$LANGS['cat_CR'] = "Κόστα Ρίκα";
$LANGS['cat_CI'] = "Ακτή Ελεφαντοστού";
$LANGS['cat_HR'] = "Κροατία";
$LANGS['cat_CU'] = "Cuba";
$LANGS['cat_CW'] = "Curaçao";
$LANGS['cat_CY'] = "Κύπρος";
$LANGS['cat_CZ'] = "Τσεχία";
$LANGS['cat_DK'] = "Δανία";
$LANGS['cat_DJ'] = "Τζιμπουτί";
$LANGS['cat_DM'] = "Ντομίνικα";
$LANGS['cat_DO'] = "Δομινικανή Δημοκρατία";
$LANGS['cat_EC'] = "Εκουαδόρ";
$LANGS['cat_EG'] = "Αίγυπτος";
$LANGS['cat_SV'] = "Ελ Σαλβαδόρ";
$LANGS['cat_GQ'] = "Ισημερινή Γουινέα";
$LANGS['cat_ER'] = "Ερυθραία";
$LANGS['cat_EE'] = "Εσθονία";
$LANGS['cat_ET'] = "Αιθιοπία";
$LANGS['cat_FK'] = "Νήσοι Φώκλαντ (Μαλβίνες)";
$LANGS['cat_FO'] = "Νήσοι Φερόε";
$LANGS['cat_FJ'] = "Φίτζι";
$LANGS['cat_FI'] = "Φινλανδία";
$LANGS['cat_FR'] = "Γαλλία";
$LANGS['cat_GF'] = "Γαλλική Γουιάνα";
$LANGS['cat_FG'] = "Γαλλική Γουιάνα";
$LANGS['cat_PF'] = "Γαλλική Πολυνησία";
$LANGS['cat_TF'] = "Γαλλικά Νότια Εδάφη";
$LANGS['cat_GA'] = "Γκαμπόν";
$LANGS['cat_GM'] = "Γκάμπια";
$LANGS['cat_GE'] = "Γεωργία";
$LANGS['cat_DE'] = "Γερμανία";
$LANGS['cat_GH'] = "Γκάνα";
$LANGS['cat_GI'] = "Γιβραλτάρ";
$LANGS['cat_GR'] = "Ελλάδα";
$LANGS['cat_GL'] = "Γριλανδία";
...
/* My Subscriptions */
$LANGS['newvideos'] = "Νέα Βίντεο";
$LANGS['addselectedto'] = "Προσθήκη των επιλεγμένων βίντεο σε:";
$LANGS['addtoplaylists'] = "Προσθήκη σε Playlists";

/* Account */
$LANGS['myaccount'] = "Ο Λογαριασμός Μου";
$LANGS['vidsfavs'] = "Βίντεο, Αγαπημένα & Playlists";
$LANGS['accountsettings'] = "Ρυθμίσεις Λογαριασμού";
$LANGS['viewinghistory'] = "Ιστορικό";
$LANGS['mychannel'] = "Το Κανάλι Μου";
$LANGS['uploadedvideos'] = "Ανεβασμένα Βίντεο";
$LANGS['new'] = "Νέο";
$LANGS['playlist'] = "Playlist";
$LANGS['videoupload'] = "Μεταφόρτωση Βίντεο";
$LANGS['nosubvideos'] = "Δεν έχετε συνδρομές...";
$LANGS['nofavvideos'] = "Δεν έχετε προσθέσει κανένα βίντεο στα αγαπημένα...";

/* My Videos */
$LANGS['sortby'] = "Ταξινόμηση κατά";
$LANGS['sorttitle'] = "Τίτλος";
$LANGS['sorttime'] = "Ώρα";
$LANGS['sortdateadded'] = "Ημερομηνία Προσθήκης";
$LANGS['sortviews'] = "Προβολές";
$LANGS['sortrating'] = "Βαθομολογία";
$LANGS['stattime'] = "Ώρα";
$LANGS['statrating'] = "Βαθμολογία";
$LANGS['statbroadcast'] = "Μετάδοση";
$LANGS['statrawfile'] = "Ακατέργαστο Αρχείο";
$LANGS['public'] = "Δημόσιο";
